...
// Test
replace github.com/k8snetworkplumbingwg/network-attachment-definition-client => github.com/SchSeba/network-attachment-definition-client v0.0.0-20240324124815-97250496a705
